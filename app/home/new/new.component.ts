...
export class NewComponent implements OnInit {
    ...
    private getInitialFeed(): void {
        this.steem.getNew(this.currentTag).subscribe((data: FeedInterface) => {
    ...
    public onLoadMore(event: ListViewEventData): void {
        ...
        this.steem.getNew(this.currentTag, LastFromFeed.author, LastFromFeed.permlink).subscribe((feed: FeedInterface) => {
