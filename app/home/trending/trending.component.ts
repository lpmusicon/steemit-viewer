...
export class TrendingComponent implements OnInit {
    ...
    private getInitialFeed(): void {
        this.steem.getTrending(this.currentTag).subscribe((data: FeedInterface) => {
    ...
    public onLoadMore(event: ListViewEventData): void {
        ...
        this.steem.getTrending(this.currentTag, LastFromFeed.author, LastFromFeed.permlink).subscribe((feed: FeedInterface) => {
